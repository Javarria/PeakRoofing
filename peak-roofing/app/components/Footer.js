export default function Footer(){
    return(
        <div className="container">
            ...
            <div className="bg-white w-full h-[400px] relative border-8 border-transparent" style={{ borderImage: "linear-gradient(45deg, #b76e79, #bb9a97, #e4c1c1) 1" }}>
                ...
                <div className="bg-white w-[300px] h-[50px] m-auto absolute top-[calc(25%+100px)] left-1/2 transform -translate-x-1/2 -translate-y-1/2 border-4 border-green-600">
                    ...
                    <a href="tel:+19196414212" className="absolute top-1/2 left-16 transform -translate-y-1/2 text-black font-bold tracking-tight hover:text-pink-500">
                        (919) 641- 4212
                    </a>
                </div>
